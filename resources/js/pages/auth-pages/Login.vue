  ...
  <div class="flex flex-col min-h-full items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="w-full max-w-md space-y-8 p-9 bg-white rounded-xl">
      ...
      <form class="mt-8 space-y-6" v-on:submit.prevent="login()">
        ...
        <div class="space-y-6">
          <FloatingInput id="emailAdress" label="Email address"  type="email" name="email" placeholder=" " @custom-change="handleEmail" />
          <FloatingInput id="password" label="Password"  type="password" name="password" placeholder=" " @custom-change="handlePassword" />
<!-- 
          <FloatingInput type="text" label="Text" placeholder=" " v-model="message" />
        ...
        <div class="flex items-center justify-between">
          <div class="flex items-center">
            <input id="remember-me" name="remember-me" type="checkbox" class="h-4w-4roundedborder-gray-300text-indigo-600focus:ring-indigo-500"/>
        ...
        <div>
          <button type="submit" class=" group relative flex w-full justify-center rounded-md border border-transparent bg-indigo-600 py-2 px-4 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 " :class="!isComplete ? 'disabled' : 'enabled'" :disabled="!isComplete" >
